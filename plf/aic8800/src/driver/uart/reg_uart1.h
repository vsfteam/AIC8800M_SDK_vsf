...
__INLINE void uart1_irqctl_pack(uint8_t ptirqen, uint8_t msirqen, uint8_t lsirqen, uint8_t txirqen, uint8_t rxirqen)
{
    REG_PL_WR(UART1_IRQCTL_ADDR,  ((uint32_t)ptirqen << 7) | ((uint32_t)msirqen << 3) | ((uint32_t)lsirqen << 2) | ((uint32_t)txirqen << 1) | ((uint32_t)rxirqen << 0));
}

__INLINE void uart1_irqctl_unpack(uint8_t* ptirqen, uint8_t* msirqen, uint8_t* lsirqen, uint8_t* txirqen, uint8_t* rxirqen)
{
...
__INLINE void uart1_dbufth_pack(uint8_t txtrigth, uint8_t rxtrigth)
{
    REG_PL_WR(UART1_DBUFTH_ADDR,  ((uint32_t)txtrigth << 9) | ((uint32_t)rxtrigth << 0));
}

__INLINE void uart1_dbufth_unpack(uint8_t* txtrigth, uint8_t* rxtrigth)
{
